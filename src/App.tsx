...
import type {  PlayerSymbol, Turn, SelectSquareHandler, GameBoardState, PlayerId, Players } from './types/types'
...
function App() {
  ...
  const handleSelectSquare: SelectSquareHandler = (row: number, col: number) => {
  ...
  return (
    <main>
      <div id="game-container">
        ...
        {(winnerName || hasDraw) && <GameOver winner={winnerName} onRestart={handleRestart}/>}
        <GameBoard
